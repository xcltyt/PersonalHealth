...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-PersonalHealth/Masonry.framework"
  install_framework "Pods-PersonalHealth/SDWebImage.framework"
  install_framework "Pods-PersonalHealth/SVProgressHUD.framework"
fi
